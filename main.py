...
from routers import projects, analytics, visitors, pages, traffic_sources, reports, auth, leads, chathistory, seo, team
import models
import os
...
class CustomCORSMiddleware(BaseHTTPMiddleware):
    async def dispatch(self, request: Request, call_next):
        ...
        allowed_origins = [
            ...
            "http://127.0.0.1:3002",  # Vite dev server alternate port
            "http://localhost:3003",  # Vite dev server alternate port
            "http://127.0.0.1:3003",  # Vite dev server alternate port
            ...
            "https://app.seo.prpwebs.com",  # If frontend is on subdomain
